...
public final class JdbcUtil {
	 ...
	 * returned value should be a detached value object, not having any ties to the active ResultSet: in
	 * particular, it should not be a Blob or Clob object but rather a byte array or String
	 ...
	 * DATE columns leaving out the time portion: These columns will explicitly be extracted as standard
	 ...
	 * <p>
	 * Note that the returned value may not be assignable to the specified required type, in case of an
	 * unknown type. Calling code needs to deal with this case appropriately, e.g. throwing a
	 ...
	 * <p>
	 * Typically invoked right before execution of a given set of statements: to decide whether the set
	 * of SQL statements should be executed through the JDBC 2.0 batch mechanism or simply in a
