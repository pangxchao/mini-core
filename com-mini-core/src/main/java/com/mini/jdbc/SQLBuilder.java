...
public class SQLBuilder {
    ...
    private static class SelectStatement extends BaseStatement {
        ...
        protected final void addSelect(String... columns) {
    ...
    private static class JoinStatement extends BaseStatement {
        ...
        protected JoinStatement(String word) {
            super(word, word);
        }
    ...
    private static class RightJoinStatement extends JoinStatement {
        ...
        protected RightJoinStatement() {
            super(R_JOIN);
        }
    }

    // Outer Join Statement
    protected static class OuterJoinStatement extends JoinStatement {
        private static final String O_JOIN = "\nOUTER JOIN ";

        protected OuterJoinStatement() {
            super(O_JOIN);
        }
    }
    ...
    private static class WhereStatement extends BaseStatement {
        ...
        protected WhereStatement(String word) {
            super(word, " AND ");
        }
        ...
        protected final void addAND() {
            this.values.add(_AND);
        }

        protected final void addOR() {
            this.values.add(_OR);
        }
    }
