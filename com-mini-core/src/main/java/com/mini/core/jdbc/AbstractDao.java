...
public abstract class AbstractDao implements JdbcInterface {
    ...
    @Nonnull
    @Override
    public <T> List<T> queryList(String str, IMapper<T> m, Object... params) {
        return readTemplate().queryList(str, m, params);
    }

    @Nonnull
    @Override
    public <T> List<T> queryList(SQLBuilder builder, IMapper<T> m) {
    ...
    @Nonnull
    @Override
    public <T> List<T> queryList(int skip, int limit, String str, IMapper<T> m, Object... params) {
        return readTemplate().queryList(skip, limit, str, m, params);
    }

    @Nonnull
    @Override
    public <T> List<T> queryList(int skip, int limit, SQLBuilder builder, IMapper<T> m) {
    ...
    @Nonnull
    @Override
    public <T> List<T> queryList(int limit, String str, IMapper<T> m, Object... params) {
        return readTemplate().queryList(limit, str, m, params);
    }

    @Nonnull
    @Override
    public <T> List<T> queryList(int limit, SQLBuilder builder, IMapper<T> m) {
    ...
    @Nonnull
    @Override
    public <T> List<T> queryList(Paging paging, String str, IMapper<T> m, Object... params) {
        return readTemplate().queryList(paging, str, m, params);
    }

    @Nonnull
    @Override
    public <T> List<T> queryList(Paging paging, SQLBuilder builder, IMapper<T> m) {
    ...
    @Nullable
    @Override
    public <T> T queryObject(String str, IMapper<T> m, Object... params) {
        return readTemplate().queryObject(str, m, params);
    }

    @Nullable
    @Override
    public <T> T queryObject(SQLBuilder builder, IMapper<T> m) {
