...
public final class XString extends XAbstract<String, XString> {
	...
	@Nonnull
	@Override
	protected final XString getThis() {
		return this;
	}

	public final XString isEmpty() {
		return filter(String::isEmpty);
	}

	public final XString isNotEmpty() {
		return filter(v -> !v.isEmpty());
	}

	public final XString isBlank() {
		return filter(String::isBlank);
	}

	public final XString isNotBlank() {
		return filter(v -> !v.isBlank());
	}
	...
	public final XString stripStart() {
		return map(String::stripLeading);
	}

	public final XString stripEnd() {
		return map(String::stripTrailing);
	}

	public final XString subString(int begin) {
		return map(v -> v.substring(begin));
	}

	public final XString subString(int begin, int end) {
		return map(v -> v.substring(begin, end));
	}

	//public final XString stripStart(String strip) {
	//	return map(v -> {
	//
	//		v.toCharArray()
	//
	//		while (v.startsWith(strip)) {
	//			v = v.substring(strip.length());
	//		}
	//		return v;
	//	});
	//}
	//
	//public final XString stripEnd(String strip) {
	//	return map(v -> {
	//		while (v.endsWith(strip)) {
	//			v = v.substring(0, v.length() - strip.length() - 1);
	//		}
	//		return v;
	//	});
	//}
	//
	//public final XString strip(String strip) {
	//	stripStart(strip);
	//	stripEnd(strip);
	//	return this;
	//}

	public final XString equalsIgnoreCase(String str) {
		return filter(v -> v.equalsIgnoreCase(str));
	}
	...
	//private String _stripStart(String str, String strip) {
	//	if (str == null || strip == null) {
	//		return null;
	//	}
	//	if (str == null || !str.startsWith(strip)) {
	//		return str;
	//	}
	//	return str.substring(strip.length());
	//}
	//
	//private String _stripEnd(String str, String strip) {
	//	if (str == null || !str.startsWith(strip)) {
	//		return str;
	//	}
	//	return str.substring(0, str.length() - strip.length() - 1);
	//}
	//
	//private String _strip(String str, final String strip) {
	//	str = _stripEnd(str, strip);
	//	return _stripStart(str, strip);
	//}
