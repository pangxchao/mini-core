...
import static com.mini.core.web.util.WebSession.SESSION_KEY;
...
public interface ActionInvocation {
    ...
    default <T extends WebSession> T getWebSession(Class<T> clazz) {
        return clazz.cast(getSession().getAttribute(WebSession.SESSION_KEY));
    }
    ...
    default <T extends WebSession> void setWebSession(T session) {
        getSession().setAttribute(WebSession.SESSION_KEY, session);
    }
}
