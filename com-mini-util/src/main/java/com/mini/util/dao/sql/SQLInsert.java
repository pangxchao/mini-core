...
public final class SQLInsert implements SQL {
     ...
     * @return SQLInsert
     */
    public SQLInsert put(String key, String value) {
        values.add(value);
        keys.add(key);
        return this;
    }
     ...
     * @return SQLInsert
     */
    public SQLInsert put(String key) {
        return put(key, "?");
    }
     ...
     * @return SQLInsert
     */
    public SQLInsert params(Object... param) {
    ...
    public String content() {
        return StringUtil.join("", INSERT, INTO, name, "(", StringUtil.join(", ", keys), ") ", VALUES, "(", StringUtil.join(", ", values), ")");
    }
