...
import com.mini.util.lang.reflect.ParameterNameDiscoverer;
import com.mini.util.lang.reflect.ParameterNameDiscovererJavassist;
import com.mini.util.lang.scan.ClassScannerJar;
import com.mini.util.lang.scan.ClassScannerPath;
...
public class ClassUtil {
    ...
    /**
     * 获取指定Class对象的所有注解，包括父类所有私有注解
     * @param clazz 指定Class对象
     * @return 所有注解
     */
    @Nonnull
    public static List<Annotation> getAllAnnotation(Class<?> clazz) {
        ArrayList<Annotation> annotationList = new ArrayList<>();
        while (clazz != null && !clazz.equals(Object.class)) {
            Annotation[] as = clazz.getDeclaredAnnotations();
            Collections.addAll(annotationList, as);
            clazz = clazz.getSuperclass();
        }
