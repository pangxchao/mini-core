...
public final class StringUtil {
    ...
    public static boolean isBlank(String self) {
        if (StringUtil.isEmpty(self)) return true;
    ...
    public static int indexOf(String self, String str) {
        return self == null ? -1 : self.indexOf(str);
    }
    ...
    public static int indexOf(String self, String str, int from) {
        return self == null ? -1 : self.indexOf(str, from);
    }
    ...
    public static int lastIndexOf(String self, String str) {
        return self == null ? -1 : self.lastIndexOf(str);
    }
    ...
    public static int lastIndexOf(String self, String str, int from) {
        return self == null ? -1 : self.lastIndexOf(str, from);
    }
     ...
     * @param encode 编码方式
     */
    public static String urlEncode(String self, String encode) {
        try {
            return URLEncoder.encode(self, encode);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
     ...
     * @param encode 编码
     */
    public static String urlDecode(String self, String encode) {
        try {
            return URLDecoder.decode(self, encode);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
