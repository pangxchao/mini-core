...
public abstract class Log {
     ...
     * @param logger
     */
    public static void setInstance(Class<? extends ILog> logger) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Log.instance = logger.getConstructor().newInstance();
    }
