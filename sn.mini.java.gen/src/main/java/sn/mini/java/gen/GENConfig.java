...
public class GENConfig {
    ...
    public static final String PROJECT_PATH = "D:/workspace-git/sn-mini/sn.mini.java.gen"; // 项目根绝对路径
    public static final String PACKAGE_NAME = "sn.mini.kotlin.gen"; // 项目名名称

    public static final String TABLE_DB_NAME = "group_enter_info"; // 数据库表名称
    public static final String TABLE_JAVA_NAME = "GroupEnterInfo"; // java实体类名称
    public static final String DB_PREFIX_NAME = "group_"; // 表前缀名称， 如： file_id 字段名称
