...
//	public static final String DB_URL = "jdbc:mysql://192.168.1.200:3306/mengyi_common?characterEncoding=utf-8"; // 数据库连接
	...
	public static final String TABLE_DB_NAME = "answerer_info"; // 数据库表名称
	public static final String TABLE_JAVA_NAME = "AnswererInfo"; // java实体类名称
	public static final String DB_PREFIX_NAME = "answer_"; // 表前缀名称， 如： file_id 字段名称
...
//
//		String s = "group1/123/456.htm";
//		String r = "group1/${id}/${pid}.htm";
