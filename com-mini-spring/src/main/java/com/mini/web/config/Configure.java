...
public final class Configure {
     ...
     * @return @this
     */
    public synchronized final Configure registerExceptionHandler(Class<? extends ExceptionHandler> handler) {
     ...
     * @return 异常处理器列表
     */
    public synchronized final List<ExceptionHandler<?>> getHandlerList() {
