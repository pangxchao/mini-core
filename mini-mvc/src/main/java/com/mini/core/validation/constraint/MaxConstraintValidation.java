...
import com.mini.core.validation.annotation.Max;
 ...
 */
@Singleton
public final class MaxConstraintValidation implements ConstraintValidation<Max> {
	@Override
	public final void validate(Max annotation, Object value) {
