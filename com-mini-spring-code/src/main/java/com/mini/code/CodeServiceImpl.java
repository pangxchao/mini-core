...
public final class CodeServiceImpl {
    protected static void run(Configure configure, String className, String tableName, String prefix) throws Exception {
        ...
        builder.addField(FieldSpec.builder(daoClass, firstLowerCase(daoClassName), PRIVATE, FINAL).build());

        // public ${serviceImplClassName}(${className} ${firstLowerCase(className)}) {
