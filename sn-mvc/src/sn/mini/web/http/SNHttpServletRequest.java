/**
 * Created the sn.mini.web.http.SNHttpServletRequest.java
...
public class SNHttpServletRequest implements HttpServletRequest {
	...
	public Part getPart(String arg0) throws IOException, ServletException {
		return this.isMultipartContent == false ? null
			: Optional.ofNullable(this.httpServletRequest.getPart(arg0)).orElse(null);
	}
