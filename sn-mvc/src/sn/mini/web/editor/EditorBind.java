/**
 * Created the sn.mini.web.editor.EditorBind.java
...
import sn.mini.web.editor.basics.StringEditor;
import sn.mini.web.editor.date.DateEditor;
import sn.mini.web.editor.http.PartArrayEditor;
import sn.mini.web.editor.http.PartEditor;
import sn.mini.web.editor.http.RequestEditor;
import sn.mini.web.editor.http.ResponseEditor;
import sn.mini.web.editor.http.SessionEditor;
import sn.mini.web.http.SNHttpServletRequest;
import sn.mini.web.model.IModel;
import sn.mini.web.util.IUser;

/**
 * sn.mini.web.editor.EditorBind.java
 * @author XChao
 */
public class EditorBind {
	...
	private EditorBind() {
		...
		editors.put(byte.class, new sn.mini.web.editor.atomic.ByteEditor());
		editors.put(long.class, new sn.mini.web.editor.atomic.LongEditor());
		editors.put(double.class, new sn.mini.web.editor.atomic.DoubleEditor());
		editors.put(float.class, new sn.mini.web.editor.atomic.FloatEditor());
		editors.put(short.class, new sn.mini.web.editor.atomic.ShortEditor());
		editors.put(int.class, new sn.mini.web.editor.atomic.IntEditor());
		editors.put(boolean.class, new sn.mini.web.editor.atomic.BooleanEditor());

		editors.put(Byte.class, new sn.mini.web.editor.basics.ByteEditor());
		editors.put(Long.class, new sn.mini.web.editor.basics.LongEditor());
		editors.put(Double.class, new sn.mini.web.editor.basics.DoubleEditor());
		editors.put(Float.class, new sn.mini.web.editor.basics.FloatEditor());
		editors.put(Short.class, new sn.mini.web.editor.basics.ShortEditor());
		editors.put(Integer.class, new sn.mini.web.editor.basics.IntegerEditor());
		editors.put(Boolean.class, new sn.mini.web.editor.basics.BooleanEditor());
