...
public final class TypeSpecBuilder {
    ...
    public TypeSpecBuilder ifAdd(boolean bool, Consumer<TypeSpecBuilder> consumer) {
        if (bool) consumer.accept(this);
        return this;
    }

    public <T> TypeSpecBuilder forAdd(Collection<T> collection, BiConsumer<TypeSpecBuilder, T> consumer) {
