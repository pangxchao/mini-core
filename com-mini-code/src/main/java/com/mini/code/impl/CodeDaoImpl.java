...
public final class CodeDaoImpl {
    ...
    protected static void run(Configure configure, ClassInfo info, String tableName, String prefix, //
        ...
        // 生成JdbcTemplate属性
        builder.addField(FieldSpec.builder(JdbcTemplate.class, "jdbcTemplate", PRIVATE)
                .build());

        // 生成 Mapper 属性
        builder.addField(FieldSpec.builder(info.mapperClass, firstLowerCase(info.mapperName), PRIVATE)
                .build());
