...
import sn.mini.java.util.lang.ArraysUtil;
...
public abstract class AbstractDao implements IDao {
    ...
    public JSONArray query(Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, sql.cells()), sql);
    }

    @Override
    public JSONArray query(String sql, Object... params) {
        return this.executeQuery(DaoUtil::analysis, sql, params);
    }

    @Override
    public <T> List<T> query(Class<T> clazz, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, clazz, sql.cells()), sql);
    }

    @Override
    public <T> List<T> query(Class<T> clazz, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, clazz), sql, params);
    }

    @Override
    public <T> List<T> query(IRow<T> mapper, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, mapper), sql);
    }

    @Override
    public <T> List<T> query(IRow<T> mapper, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, mapper), sql, params);
    }

    @Override
    public JSONArray query(Paging paging, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, sql.cells()), paging, sql);
    }

    @Override
    public JSONArray query(Paging paging, String sql, Object... params) {
        return this.executeQuery(DaoUtil::analysis, paging, sql, params);
    }

    @Override
    public <T> List<T> query(Paging paging, Class<T> clazz, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, clazz, sql.cells()), paging, sql);
    }

    @Override
    public <T> List<T> query(Paging paging, Class<T> clazz, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, clazz), paging, sql, params);
    }

    @Override
    public <T> List<T> query(Paging paging, IRow<T> mapper, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, mapper), paging, sql);
    }

    @Override
    public <T> List<T> query(Paging paging, IRow<T> mapper, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysis(resultSet, mapper), paging, sql, params);
    }

    @Override
    public JSONObject queryOne(Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysisOne(resultSet, sql.cells()), sql);
    }

    @Override
    public JSONObject queryOne(String sql, Object... params) {
        return this.executeQuery(DaoUtil::analysisOne, sql, params);
    }

    @Override
    public <T> T queryOne(Class<T> clazz, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysisOne(resultSet, clazz, sql.cells()), sql);
    }

    @Override
    public <T> T queryOne(Class<T> clazz, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysisOne(resultSet, clazz), sql, params);
    }

    @Override
    public <T> T queryOne(IRow<T> mapper, Sql sql) {
        return this.executeQuery(resultSet -> DaoUtil.analysisOne(resultSet, mapper), sql);
    }

    @Override
    public <T> T queryOne(IRow<T> mapper, String sql, Object... params) {
        return this.executeQuery(resultSet -> DaoUtil.analysisOne(resultSet, mapper), sql, params);
    }
    ...
    public boolean queryBoolean(String sql, Object... params) {
        return this.executeQuery(resultSet -> (resultSet.next() && resultSet.getBoolean(1)), sql, params);
    }
