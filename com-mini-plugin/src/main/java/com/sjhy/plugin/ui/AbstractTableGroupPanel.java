...
public abstract class AbstractTableGroupPanel<T extends AbstractGroup<E>, E> {
	...
	private void $$$setupUI$$$() {
		...
		mainPanel.add(groupComboBox, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
			GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final JScrollPane scrollPane1 = new JScrollPane();
		mainPanel.add(scrollPane1, new GridConstraints(1, 0, 2, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
		...
		mainPanel.add(toolBar1, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
			GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		copyGroupButton = new JButton();
		copyGroupButton.setIcon(new ImageIcon(getClass().getResource("/actions/copy.png")));
		toolBar1.add(copyGroupButton);
		deleteGroupButton = new JButton();
		deleteGroupButton.setIcon(new ImageIcon(getClass().getResource("/actions/delete.png")));
		toolBar1.add(deleteGroupButton);
		final JToolBar toolBar2 = new JToolBar();
		toolBar2.setBorderPainted(false);
		toolBar2.setFloatable(false);
		toolBar2.setOrientation(1);
		mainPanel.add(toolBar2, new GridConstraints(1, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
			GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(-1, 20), null, 0, false));
		addItemButton = new JButton();
		addItemButton.setIcon(new ImageIcon(getClass().getResource("/general/add.png")));
		toolBar2.add(addItemButton);
		deleteItemButton = new JButton();
		deleteItemButton.setIcon(new ImageIcon(getClass().getResource("/actions/delete.png")));
		toolBar2.add(deleteItemButton);
		final Spacer spacer1 = new Spacer();
		mainPanel.add(spacer1, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1,
