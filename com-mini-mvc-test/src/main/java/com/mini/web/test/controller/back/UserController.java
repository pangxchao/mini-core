...
public class UserController {
    ...
    public void pages(PageModel model, Paging paging, int district, String token, String search, String sortField, int sortType,
        ...
        Object[] result = sortType == 1 ? userInfoList.stream().sorted((o1, o2) -> (int) (o2.getId() - o1.getId()))
                .skip(paging.getSkip()).limit(paging.getLimit()).toArray() //
                : userInfoList.stream().sorted((o1, o2) -> (int) (o1.getId() - o2.getId()))
                .skip(paging.getSkip()).limit(paging.getLimit()).toArray();
