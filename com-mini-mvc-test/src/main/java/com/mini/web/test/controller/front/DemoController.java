 ...
 * <p>本示例演示借助Layui table 转换静态表格的功能做一个后台管理页面</p>
 * <p>该接口与Back/Demo接口的一些功能是相同的，只在演示不同的实现</p>
 * @author xchao
 */
@Singleton
...
public class DemoController {
    ...
    public void pages(PageModel model, Paging paging, String search, int sortType, int phone, int email,
        ...
        model.addData("userList", userService.search(paging, search, sortType, phone, email,
                regionIdUri.toString(), startTime, endTime));
