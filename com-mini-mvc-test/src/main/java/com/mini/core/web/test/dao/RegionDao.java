...
import com.mini.core.web.test.dao.base.RegionBaseDao;
import com.mini.core.web.test.dao.impl.RegionDaoImpl;
import com.mini.core.web.test.entity.Region;

import java.util.List;

import static com.mini.core.web.test.entity.Region.REGION_ID;
