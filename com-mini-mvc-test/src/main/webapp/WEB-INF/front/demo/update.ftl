    ...
    <form class="layui-form mini-form" action="" id="updateForm" lay-filter="updateForm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    ...
                    <#else >
                        <input type="radio" name="phoneAuth" value="1" title="是" lay-filter="phoneAuth"/>
                        <input type="radio" name="phoneAuth" value="0" title="否" checked lay-filter="phoneAuth"/>
                    </#if>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input type="text" name="fullName" class="layui-input" value="${user.fullName!}"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input type="text" name="email" class="layui-input" value="${user.email!}"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    ...
                    <#else >
                        <input type="checkbox" name="emailAuth" value="1" title="认证邮箱" lay-filter="emailAuth"/>
                    </#if>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="hidden" name="headUrl" value="${user.headUrl!}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="cityEdit" id="cityEdit" url="mobile/region/list.htm?id=" def="${city!}" child="regionId" placeholder="请选择市">
            ...
            <div class="layui-input-inline">
                <select name="regionId" id="regionId" url="mobile/region/list.htm?id=" def="${regionId!}" placeholder="请选择县/区">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block mini-input-block">
                <button class="layui-btn layui-btn-sm" lay-submit style="display: none;"
                        lay-filter="updateButton" id="updateButton">立即提交
                </button>
            </div>
        </div>
    </form>
