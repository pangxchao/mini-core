...
<!-- 该模板用于对每行数据的操作 -->
<script type="text/html" id="auto_phone">
    {{# if(d.phoneAuth === '1') { }}
    是
    {{# } else { }}
    否
...
<script type="text/html" id="auto_email">
    {{# if(d.emailAuth === '1') { }}
    是
    {{# } else { }}
    否
...
<script type="text/html" id="head_url">
    ...
    <img src="{{=d.fullHeadUrl}}" alt="{{=d.fullHeadUrl}}"/>
    {{# } }}
</script>
...
<script type="text/html" id="lineBar">
    ...
    {{# if(d.phoneAuth !== '1') { }}
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="auth">认证手机</a>
    {{# } }}
</script>
