<div class=" mini-main">
    {{# console.log(d)}}
    <form class="layui-form mini-form" action="" id="editFormEl" lay-filter="updateForm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="hidden" name="headUrl" value="{{=d.headUrl}}"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="regionId" id="regionId" url="mobile/region/list.htm?id=" def="{{=d.regionId}}" placeholder="请选择县/区">
