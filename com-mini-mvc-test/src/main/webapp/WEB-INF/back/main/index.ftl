	...
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-left">
			<li class="layui-nav-item">
				<a href="http://www.coursemaker.cn/"
						target="_blank">二级导航带图标
				</a>
			...
			<li class="layui-nav-item">
				<a href="javascript:">
					...
					<span class="layui-badge-dot"
							style="margin: -15px -20px 0;"></span>
					<label>${userName!}</label>
				</a>
				<dl class="layui-nav-child">
					<dd>
						<a href="javascript:void(0)"
								style="min-width: 300px">基本资料
						</a>
					</dd>
					<dd>
						<a href="javascript:void(0)"
	...
	<div class="layui-side layui-bg-black">
		<div class="layui-side-scroll">
			...
			<ul class="layui-nav layui-nav-tree"
				...
				<li class="layui-nav-item layui-nav-itemed">
					<a class=""
							href="javascript:">后台模块
					</a>
					<dl class="layui-nav-child">
						<dd>
							<a href="back/demo/index.htm"
									target="center">DEMO页面
							</a>
						</dd>
						<dd>
							<a href="back/init/index.htm"
									target="center">参数管理
							</a>
						</dd>
						<dd>
							<a href="back/user/index.htm"
									target="center">用户管理
							</a>
						</dd>
					</dl>
				...
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
						<dd>
							<a href="front/demo/index.htm"
									target="center">DEMO页面
							</a>
						</dd>
						<dd>
							<a href="front/user/index.htm"
									target="center">用户管理
							</a>
						</dd>
					</dl>
				...
				<!-- 首页连接 -->
				<li class="layui-nav-item layui-nav-itemed">
					<a href="web_socket/index.htm"
							target="center">WebSocket
					</a>
				</li>
			</ul>
		</div>
