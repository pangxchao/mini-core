/**
 * Created the sn.mini.java.web.listener.MenuServletContextListener.java
...
import sn.mini.java.web.annotaion.Menu;
import sn.mini.java.web.http.ActionProxy;
import sn.mini.java.web.util.IMenu;
import sn.mini.java.web.util.IRole;
import sn.mini.java.web.util.IRoleMenu;

/**
 * sn.mini.java.web.listener.MenuServletContextListener.java
 * @author XChao
 */
