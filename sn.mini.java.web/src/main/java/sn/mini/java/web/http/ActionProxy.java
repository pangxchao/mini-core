/**
 * Created the sn.mini.java.web.http.ActionProxy.java
...
/**
 * sn.mini.java.web.http.ActionProxy.java
 * @author XChao
 */
public final class ActionProxy {
    ...
    public String invoke() {
        ...
        return (result instanceof String) ? String.valueOf(result) : this.getPath();
    }
