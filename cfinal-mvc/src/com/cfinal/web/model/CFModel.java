...
public interface CFModel extends CFBasics {
	 ...
	 * @param input
	 */
	public CFModel setInputStream(InputStream input);
	 ...
	 * @author XChao
	 */
	public static interface DataModel<T> {
		public int getError();

		public DataModel<T> setError(int error);

		public String getMessage();

		public DataModel<T> setMessage(String message);
