/**
 * Created the com.cfinal.web.scheduler.CFTimmertaskPattern.java
...
import com.cfinal.web.timmer.matcher.CFTaskAlwaysMatcher;
import com.cfinal.web.timmer.matcher.CFTaskDayOfMonthMatcher;
import com.cfinal.web.timmer.matcher.CFTaskIntegerMatcher;
import com.cfinal.web.timmer.matcher.CFTaskMatcher;
import com.cfinal.web.timmer.parser.CFTaskDayOfMonthParser;
import com.cfinal.web.timmer.parser.CFTaskDayOfWeekParser;
import com.cfinal.web.timmer.parser.CFTaskHourParser;
import com.cfinal.web.timmer.parser.CFTaskMinuteParser;
import com.cfinal.web.timmer.parser.CFTaskMonthParser;
import com.cfinal.web.timmer.parser.CFTaskParser;

/**
 * com.cfinal.web.scheduler.CFTimmertaskPattern.java
 * @author XChao
 */
public class CFTimmerPattern {
	...
	protected CFTimmerPattern(String pattern) {
	...
	public boolean match(TimeZone timezone, long millis) {
		...
		if(dayOfMonthMatcher instanceof CFTaskDayOfMonthMatcher) {
			result = result
				&& ((CFTaskDayOfMonthMatcher) dayOfMonthMatcher).match(dayOfMonth, month, gc.isLeapYear(year));
		} else {
