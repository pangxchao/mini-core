/**
 * Created the com.cfinal.web.editor.atomic.CFAtomicByteEditor.java
...
/**
 * com.cfinal.web.editor.atomic.CFAtomicByteEditor.java
 * @author XChao
 */
public class CFAtomicByteEditor extends CFAbstractEditor {
