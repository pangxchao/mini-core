...
public class CFFileGenerator {
	...
	public static void setPrivateFilePath(String privateFilePath) {
		CFFileGenerator.privateFilePath = privateFilePath;
	}
	...
	public static void setPublicFilePath(String publicFilePath) {
		CFFileGenerator.publicFilePath = publicFilePath;
	}
	...
	public static void setPublicFileUrl(String publicFileUrl) {
		CFFileGenerator.publicFileUrl = publicFileUrl;
	}
	...
	public static String getDateDBPath(String fileExt) {
		return FORMAT.format(new Date(System.currentTimeMillis())) + CFPKGenerator.key() + fileExt;
	}
	...
	public static String getKeyDBPath(long key, String fileExt) {
		return FORMAT.format(new Date(CFPKGenerator.millis(key))) + key + fileExt;
	}
