 ...
 * @author XChao
 */
public class CFHttpsRequest extends CFHttpRequest {
	public CFHttpsRequest(String url) {
		super(url);
		setSSLSocketFactory(getInitSSLSocketFactory());
	}

	public CFHttpsRequest(String url, Proxy proxy) {
		super(url, proxy);
		setSSLSocketFactory(getInitSSLSocketFactory());
	}

	public CFHttpsRequest(HttpURLConnection connection) {
		super(connection);
		setSSLSocketFactory(getInitSSLSocketFactory());
	}
