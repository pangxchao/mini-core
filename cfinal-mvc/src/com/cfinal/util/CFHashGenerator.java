...
public class CFHashGenerator {
	...
	private static final CFHashGenerator instence = new CFHashGenerator();

	public static CFHashGenerator getInstence() {
		return instence;
	}

	private CFHashGenerator() {
