...
public final class UpdateSql extends AbstractSql<UpdateSql> implements JoinFragment<UpdateSql> {
    ...
    @Override
    public UpdateSql join(String join) {
        this.join.join(join);
        return this;
    }

    @Override
    public UpdateSql join(String table, String column, String target) {
        this.join.join(table, column, table);
        return this;
    }

    @Override
    public UpdateSql join(String table, Consumer<JoinOnStatement> consumer) {
        this.join.join(table, consumer);
        return this;
    }

    @Override
    public UpdateSql leftJoin(String join) {
        this.join.leftJoin(join);
        return this;
    }

    @Override
    public UpdateSql leftJoin(String table, String column, String target) {
        this.join.leftJoin(table, column, target);
        return this;
    }

    @Override
    public UpdateSql leftJoin(String table, Consumer<JoinOnStatement> consumer) {
        this.join.leftJoin(table, consumer);
        return this;
    }

    @Override
    public UpdateSql rightJoin(String join) {
        this.join.rightJoin(join);
        return this;
    }

    @Override
    public UpdateSql rightJoin(String table, String column, String target) {
        this.join.rightJoin(table, column, target);
        return this;
    }

    @Override
    public UpdateSql rightJoin(String table, Consumer<JoinOnStatement> consumer) {
        this.join.rightJoin(table, consumer);
        return this;
    }

    @Override
    public UpdateSql leftOuterJoin(String join) {
        this.join.leftOuterJoin(join);
        return this;
    }

    @Override
    public UpdateSql leftOuterJoin(String table, String column, String target) {
        this.join.leftOuterJoin(table, column, target);
        return this;
    }

    @Override
    public UpdateSql leftOuterJoin(String table, Consumer<JoinOnStatement> consumer) {
        this.join.leftOuterJoin(table, consumer);
        return this;
    }

    @Override
    public UpdateSql rightOuterJoin(String join) {
        this.join.rightOuterJoin(join);
        return this;
    }

    @Override
    public UpdateSql rightOuterJoin(String table, String column, String target) {
        this.join.rightOuterJoin(table, column, target);
        return this;
    }

    @Override
    public UpdateSql rightOuterJoin(String table, Consumer<JoinOnStatement> consumer) {
        this.join.rightOuterJoin(table, consumer);
        return this;
    }

    @Override
    public UpdateSql crossJoin(String join) {
        this.join.crossJoin(join);
        return this;
    }

    @Override
    public UpdateSql crossJoin(String table, String column, String target) {
        this.join.crossJoin(table, column, target);
        return this;
    }

    @Override
    public UpdateSql crossJoin(String table, Consumer<JoinOnStatement> consumer) {
