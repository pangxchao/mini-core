package com.mini.core.data.transaction;
...
@Aspect
@Component
public class TransactionMultiInterceptor {
    private final ApplicationContext applicationContext;

    @Autowired
    public TransactionMultiInterceptor(ApplicationContext applicationContext) {
     ...
     * @return 返回目标方法返回对象
     */
    @Around(value = "@annotation(com.mini.core.data.transaction.TransactionalMulti)")
    public Object transactionalMultiAspectAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        var transactionalMulti = method.getAnnotation(TransactionalMulti.class);
